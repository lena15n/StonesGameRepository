 ...
 */
var STONESGAMEFORMNAME = 'moodle-qtype_ddmarker-form';
var STONESGAME_FORM = function() {
    STONESGAME_FORM.superclass.constructor.apply(this, arguments);
};
Y.extend(STONESGAME_FORM, M.qtype_stonesgame.dd_base_class, {
    fp : null,
...
},{NAME : STONESGAMEFORMNAME, ATTRS : {maxsizes:{value:null}}});

M.qtype_stonesgame = M.qtype_ddmarker || {};
M.qtype_stonesgame.init_form = function(config) {
    return new STONESGAME_FORM(config);
};
